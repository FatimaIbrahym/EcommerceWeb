                                            ...
                                            <div class="col-xl-12 col-md-12">
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <button id="myBtn" type="button" style="float:right; " class="btn btn-primary"><i class="fa fa-plus"></i>Add subCategory</button>
    ...
    <div class="modal-content">
        ...
        <h3>Add subCategory</h3>
              ...
              <div class="form-group">
			    <label for="exampleInputEmail1">Name of subCategory</label>
...
<div class="modal-content">
  ...
  <div class="form-group">
    ...
    <input style="display:none;" type="text" class="form-control" id="id2" name="id2" >
    <input style="display:none;" type="text" class="form-control" id="idP" name="idP" >

  </div>
 
  <button type="submit" name="modifCat" class="add0 btn btn-primary">Modifier</button>
</form>
</div>
</div>
...
<div class="modal-content">
    ...
    <h3>Detele subCategory</h3>
    <h4>Are you sure you want to delete this subCategory ?</h4>
    <form method="post">
    <input type="text" style="display:none;" id="id3" name="id3"/>
    <input type="text" style="display:none;"  id="idp1" name="idp1"/>
